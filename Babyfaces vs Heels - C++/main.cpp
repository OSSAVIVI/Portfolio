/***************************************************************************************
** Program Name: Homework 4 Problem 4
...
int main()
{
    ...
    Menu menu = Menu("Homework 5 Problem 3"); //calls constructor with the name of the game as a parameter
        ...
        if (userChoice == 1)
        {
            ...
            while (restart3 == true)
            {
                if (menuOptionsChoice == 1)
                {
                    ...
                    cout << "Executing Babyfaces vs Heels...(user chose '1')" << endl;
                    cout << aestheticLine << endl;
                    std::cout << "Please type the name of the file" <<std::endl;
                    std::cout << "you'd like to examine, and then" <<std::endl;
                    std::cout << "hit ENTER (example: wrestler2.txt)." <<std::endl;
                    string fileName;
                    std::cin >> fileName;
                    std::cout << "\nProcessing '" << fileName << "'...please wait...\n" << std::endl;
                    Wrestler wrestler;
                    int sizeOfArray = wrestler.countNumberOfCharactersInFile(fileName);
                    std::string storingArray[sizeOfArray];
                    wrestler.readValuesFromFile(fileName, storingArray, sizeOfArray);
                    //wrestler.printArrayToConsole(storingArray, sizeOfArray);

                    wrestler.multiLineHandler(storingArray, sizeOfArray);
