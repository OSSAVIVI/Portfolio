 ...
 ** Author: Ryan Wells Farran | File Name: inputVal.cpp
 ** Class: CS 162 400 S2019 (Intro to CS II) | Date: 06/11/2019 | Tuesday, June 11th 2019
 ** Description: Implementation file for the InputVal Class.
 ***************************************************************************************/
#include <stdio.h>
#include <iostream>
#include <string>
...
{
    int userInput; //commented out line below for sake of console output cleanliness
