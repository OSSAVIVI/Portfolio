...
int main()
{
    ...
    Menu menu = Menu("Homework 4 Problem 4"); //calls constructor with the name of the game as a parameter
        ...
        if (userChoice == 1)
        {
            ...
            while (restart3 == true)
            {
                if (menuOptionsChoice == 1)
                {
                    ...
                    std::cout << "Please see the results below:" <<std::endl;
                    
                    MergeSort merge;
                    //merge.countNumberOfCharactersInFile("act.txt");
                    ActivitySelection activitySelect;
                    
                    activitySelect.multiLineHandler("act.txt");
