/***************************************************************************************
** File Name: StoogeSort.cpp
** Description: This is the implementation file of the StoogeSort class.
***************************************************************************************/
...
int StoogeSort::countNumberOfCharactersInFile(std::string inputFileName)
{
    int count = 0;
    int storingArray[1];
    ...
    else
    {
        ...
        { //reads data from file into array
            ...
            std::cout << "COUNTING RYAN Character " << count << ": " << storingArray[0] << std::endl;
...
int StoogeSort::countNumberOfNewLinesInFile(std::string inputFileName)
{
    int count = 1;
    char storingArray[1];
...
void StoogeSort::readValuesFromFile(std::string inputFileName, int* storingArray)
{
...
void StoogeSort::printArrayToConsole(const int* arrayToPrint, int sizeOfArray)
{
...
void StoogeSort::printDynArrayToConsole(DynArr* arrayToPrint, int sizeOfArray)
{
    //std::cout << aestheticLine << std::endl;
    //std::cout << "Your array is printed below: " << std::endl;
    for (int arrayIndex = 0; arrayIndex < sizeOfArray; arrayIndex++)
...
void StoogeSort::multiLineHandler(const int* arrayToHandle, int sizeOfArray)
{
    //std::cout << aestheticLine << std::endl;
    DynArr* finalArray;
    ...
    while(sizeOfArray > 0)
    {
        ...
        if (backUpSize2 > 0)
        {
            std::cout << "Initiating Stooge Sort on unsorted array #" << lineNum << ":" << std::endl;
            printArrayToConsole(arrayToSort, backUpSize2);
            
            //CODE FOR STOOGE SORT
            recursiveStoogeSort(arrayToSort, 0, backUpSize2 - 1);
    ...
    std::cout << "(Stooge-sorted arrays have been printed to \"stooge.txt\")" << std::endl;
}

//THis function writes
void StoogeSort::outputValuesToFile(DynArr* sortedArray, int sizeOfArray)
{
    //std::cout << aestheticLine << std::endl;
    std::ofstream outputFile;
    std::string fileName = "stooge.txt";
...
//Recursive case with base case Stooge subroutine
void StoogeSort::recursiveStoogeSort(int* arrayToSort, int begIndex, int endIndex)
{
...
int StoogeSort::convertCharToInt(char charToConvert)
{
...
DynArr* StoogeSort::convertIntArrayToDynArr(const int* arrayToAdd, int sizeOfArray)
{
    DynArr* newArray;
...
void StoogeSort::addToFinalArray(DynArr* arrayToAddTo, DynArr* arrayToAdd, int sizeOfArray)
{
    for (int index = 0; index < sizeOfArray; index++)
    {
...
*/
void StoogeSort::initDynArr(DynArr *v, int capacity)
{
    assert(capacity > 0);
    assert(v!= 0);
...
*/
DynArr* StoogeSort::newDynArr(int cap)
{
    assert(cap > 0);
...
*/
void StoogeSort::freeDynArr(DynArr *v)
{
    if(v->data != 0)
    {
...
*/
void StoogeSort::deleteDynArr(DynArr *v)
{
...
*/
int StoogeSort::sizeDynArr(DynArr *v)
{
    return v->size;
}
...
*/
void StoogeSort::addDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
    v->data[v->size] = val;
    v->size++;
...
*/
TYPE StoogeSort::getDynArr(DynArr *v, int pos)
{
    /* FIXME: You will write this function */
...
*/
void StoogeSort::putDynArr(DynArr *v, int pos, TYPE val)
{
    /* FIXME: You will write this function */
    v->data[pos] = val;
}
...
*/
void StoogeSort::swapDynArr(DynArr *v, int i, int  j)
{
    /* FIXME: You will write this function */
    TYPE temp = v->data[i];
    v->data[i] = v->data[j];
...
*/
void StoogeSort::removeAtDynArr(DynArr *v, int idx)
{
    /* FIXME: You will write this function */
...
*/
int StoogeSort::isEmptyDynArr(DynArr *v)
{
    /* FIXME: You will write this function */
...
*/
void StoogeSort::pushDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
...
*/
TYPE StoogeSort::topDynArr(DynArr *v)
{
    /* FIXME: You will write this function */
    TYPE returnValue = '|';
...
*/
void StoogeSort::popDynArr(DynArr *v)
{
    /* FIXME: You will write this function */
    if (isEmptyDynArr(v) == 0)
    {
...
*/
int StoogeSort::containsDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
    int booleanValue = 0;
...
*/
void StoogeSort::removeDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
