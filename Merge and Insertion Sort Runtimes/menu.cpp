...
int Menu::getMenuOptions()
{
    ...
    std::cout << "[menu]     - 1. Sort data.txt using MERGE SORT." << std::endl;
    std::cout << "[menu]     - 2. Sort data.txt using INSERTION SORT." << std::endl;
    std::cout << "[menu]     - 3. Test MERGE and INSERTION sort runtimes." << std::endl;
    std::cout << "[menu]     - 4. QUIT (back to START/EXIT)." << std::endl;
    //std::cout << aestheticLine << std::endl;
