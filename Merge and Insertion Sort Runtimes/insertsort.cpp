...
** Description: This is the implementation file of the InsertionSort class.
***************************************************************************************/
...
int InsertionSort::countNumberOfCharactersInFile(std::string inputFileName)
{
    int count = 0;
    int storingArray[1];
...
int InsertionSort::countNumberOfNewLinesInFile(std::string inputFileName)
{
    int count = 1;
    char storingArray[1];
...
void InsertionSort::readValuesFromFile(std::string inputFileName, int* storingArray)
{
...
void InsertionSort::printArrayToConsole(const int* arrayToPrint, int sizeOfArray)
{
...
void InsertionSort::printDynArrayToConsole(DynArr* arrayToPrint, int sizeOfArray)
{
    //std::cout << aestheticLine << std::endl;
    //std::cout << "Your array is printed below: " << std::endl;
    for (int arrayIndex = 0; arrayIndex < sizeOfArray; arrayIndex++)
...
void InsertionSort::multiLineHandler(const int* arrayToHandle, int sizeOfArray)
{
    //std::cout << aestheticLine << std::endl;
    DynArr* finalArray;
    ...
    while(sizeOfArray > 0)
    {
        ...
        if (backUpSize2 > 0)
        {
            std::cout << "Initiating Insertion Sort on unsorted array #" << lineNum << ":" << std::endl;
            printArrayToConsole(arrayToSort, backUpSize2);
            
            //CODE FOR InsertionSort with MERGE SUBROUTINE GOES HERE
            insertionSorter(arrayToSort, backUpSize2);
...
void InsertionSort::outputValuesToFile(DynArr* sortedArray, int sizeOfArray)
{
    //std::cout << aestheticLine << std::endl;
    std::ofstream outputFile;
    std::string fileName = "insert.txt";
...
void InsertionSort::insertionSorter(int* arrayToSort, int sizeOfArray)
{
...
//INSERTION SORT CODE ABOVE



int InsertionSort::convertCharToInt(char charToConvert)
{
...
DynArr* InsertionSort::convertIntArrayToDynArr(const int* arrayToAdd, int sizeOfArray)
{
    DynArr* newArray;
...
void InsertionSort::addToFinalArray(DynArr* arrayToAddTo, DynArr* arrayToAdd, int sizeOfArray)
{
    for (int index = 0; index < sizeOfArray; index++)
    {
...
*/
void InsertionSort::initDynArr(DynArr *v, int capacity)
{
    assert(capacity > 0);
    assert(v!= 0);
...
*/
DynArr* InsertionSort::newDynArr(int cap)
{
    assert(cap > 0);
...
*/
void InsertionSort::freeDynArr(DynArr *v)
{
    if(v->data != 0)
    {
...
*/
void InsertionSort::deleteDynArr(DynArr *v)
{
...
void InsertionSort::_dynArrSetCapacity(DynArr *v, int newCap)
{
...
*/
int InsertionSort::sizeDynArr(DynArr *v)
{
    return v->size;
}
...
*/
void InsertionSort::addDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
    v->data[v->size] = val;
    v->size++;
...
*/
TYPE InsertionSort::getDynArr(DynArr *v, int pos)
{
    /* FIXME: You will write this function */
...
*/
void InsertionSort::putDynArr(DynArr *v, int pos, TYPE val)
{
    /* FIXME: You will write this function */
    v->data[pos] = val;
}
...
*/
void InsertionSort::swapDynArr(DynArr *v, int i, int  j)
{
    /* FIXME: You will write this function */
    TYPE temp = v->data[i];
    v->data[i] = v->data[j];
...
*/
void InsertionSort::removeAtDynArr(DynArr *v, int idx)
{
    /* FIXME: You will write this function */
...
*/
int InsertionSort::isEmptyDynArr(DynArr *v)
{
    /* FIXME: You will write this function */
...
*/
void InsertionSort::pushDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
...
*/
TYPE InsertionSort::topDynArr(DynArr *v)
{
    /* FIXME: You will write this function */
    TYPE returnValue = '|';
...
*/
void InsertionSort::popDynArr(DynArr *v)
{
    /* FIXME: You will write this function */
    if (isEmptyDynArr(v) == 0)
    {
...
*/
int InsertionSort::containsDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
    int booleanValue = 0;
...
*/
void InsertionSort::removeDynArr(DynArr *v, TYPE val)
{
    /* FIXME: You will write this function */
